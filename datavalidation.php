    ...
    <div class="row">
        <div class="col-md-12">
            <form class="cmxform" id="form" method="get" action="">
                <p>
                    <br><label for="cname">name</label>
                    <input id="cname" name="name" minlength="6" type="text" required="">
                </p>

                <!--<p>-->
                <!--        <br><label for="cname">email</label>-->
                <!--                <input id="cname" name="email" type="text" required>-->
                <!--</p>-->
                <!--        <br><label>password</label><input type="text" name="password">-->
                <!--        <br><label>gender</label>-->
                <!--        <br><input type="checkbox" name="checkbox" value="male">-->
                <!--        <br><input type="checkbox" name="checkbox" value="female"><br>-->
                <!--        <br><label>DOB:</label> <name="DOB"><br>-->
                <!--        <br>-->
